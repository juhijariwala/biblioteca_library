...
public class MenuFactory {
    ...
    public Menu createMovieMenu(LibraryCollection<Movie> movieList, IODevice ioDevice) {
        ...
        movieCheckoutSubmenu.addCommand(3,new SecurityMenuItem(
                new GenerateReportMenuItem(movieLibraryPrintingFormat),memberSession,Role.LIBRARIAN));
    ...
    public Menu createBookMenu(LibraryCollection<Book> bookList, IODevice ioDevice) {
        ...
        bookCheckoutSubmenu.addCommand(3,new SecurityMenuItem(new GenerateReportMenuItem(bookLibraryPrintingFormat),memberSession,Role.LIBRARIAN));
